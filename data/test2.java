...
public class WorldChunkManagerRTG extends WorldChunkManager
{
	...
	public WorldChunkManagerRTG(long par1, WorldType par3WorldType) {
		this();
		GenLayer[] agenlayer = GenLayerRTG.initializeAllBiomeGenerators(par1, par3WorldType);
	...
	public int getRiverStrength(int i, int j) {
		// TODO Auto-generated method stub
		return 0;
	}

	public RealisticBiomeBase getBiomeDataAt(int i, int j) {
		// TODO Auto-generated method stub
		return RealisticBiomeVanillaBase.vanillaPlains;
	}

	public float calculateRiver(int i, int j, float river, float rNoise) {
		// TODO Auto-generated method stub
		return 0f;
	}

	public float getOceanValue(int i, int j) {
		// TODO Auto-generated method stub
		return 0f;
	}
}